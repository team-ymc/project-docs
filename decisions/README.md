...
| [ADR-003](ADR-003-paper-id-and-duplicate-check.md) | 파일 콘텐츠 기반 중복 제거와 기본 파싱 결과 공유 | Accepted | 2026-07-21 |
| [ADR-004](ADR-004-chat-streaming-be-relay.md) | 채팅 스트리밍은 BE 경유 SSE로 하고, 대화 원본은 BE에서 관리 | Accepted | 2026-07-22 |
