...
- 배포 설정의 동일한 `PREREQUISITE_KNOWLEDGE_AGENT_ACTIVE_VARIANT`를 Backend와 AI에 주입한다. Backend는 캐시 키에, AI는 프롬프트·모델 조합 선택에 사용하며 AI 응답의 generator version과 일치하는지 검증한다.
